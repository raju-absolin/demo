...
import {
	addItemgroup,
	editItemgroup,
} from "@src/store/masters/ItemGroup/itemgroup.action";
...
const AddGroupMasters = ({
	...
	const groupSchema = yup.object().shape({
		...
		//     label: yup.string().required("Please select item type"),
		//     value: yup.string().required("Please select item type"),
		// }),
	});
