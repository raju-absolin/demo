...
const MaterialIssueReport = () => {
	...
	const onFinish = ({
		...
		const ParamsData = {
			...
			materialissue: materialissue?.value,
			item: item?.value,
			batch: batch?.value,
			unit: unit?.value,
			mistatus: mistatus?.value,
		};
						...
						<Grid container spacing={2}>
							...
							<Grid
								...
								<SelectComponent
									...
									placeholder="Select Material Issue"
									loading={miniMaterialIssue.loading}
									selectParams={{
										page: miniMaterialIssue.miniParams.page,
										page_size:
											miniMaterialIssue.miniParams
												.page_size,
										search: miniMaterialIssue.miniParams
											.search,
										no_of_pages:
											miniMaterialIssue.miniParams
												.no_of_pages,
									...
									hasMore={
										miniMaterialIssue.miniParams.page <
										miniMaterialIssue.miniParams.no_of_pages
									}
