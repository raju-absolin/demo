...
const StockTransferInReport = () => {
	...
	const onFinish = ({
		...
		var objData = {
			...
			model_name: "StockTransferInItem",
		};
		...
		const ParamsData = {
			...
			stocktransferin: stocktransferin?.value,
			item: item?.value,
			unit: unit?.value,
	...
	return (
		<GoBack
			is_goback={true}
			go_back_url={"/reports"}
			title={`Stock Transfer In Report`}
						...
						<Grid container spacing={2}>
							...
							<Grid
								...
								<SelectComponent
									...
									control={control}
									rules={{ required: true }}
									options={miniStockTransferIn?.list.map(
										(e: {
											id: string | number;
											code: string;
										}) => ({
									...
									placeholder="Select Stock Transfer In"
									loading={miniStockTransferIn.loading}
									selectParams={{
										page: miniStockTransferIn.miniParams
											.page,
										page_size:
											miniStockTransferIn.miniParams
												.page_size,
										search: miniStockTransferIn.miniParams
											.search,
										no_of_pages:
											miniStockTransferIn.miniParams
												.no_of_pages,
									...
									hasMore={
										miniStockTransferIn.miniParams.page <
										miniStockTransferIn.miniParams
											.no_of_pages
									}
									fetchapi={getMiniStockTransferIn}
									clearData={clearMiniStockTransferIn}
								/>
							</Grid>
							<Grid
								size={{
