...
const MaterialConsumptionReport = () => {
	...
	const {
		mini: { miniProject, miniWarehouse },
	...
	const onFinish = ({
		...
		var objData = {
			...
			model_name: "MaterialConsumptionItem",
		};
						...
						<Grid container spacing={2}>
							...
							<Grid
								...
								<SelectComponent
									...
									selectParams={{
										page: miniWarehouse?.miniParams?.page,
										page_size:
											miniWarehouse?.miniParams
												?.page_size,
										search: miniWarehouse?.miniParams
											?.search,
										no_of_pages:
											miniWarehouse?.miniParams
												?.no_of_pages,
									...
									hasMore={
										miniWarehouse?.miniParams?.page <
										miniWarehouse?.miniParams?.no_of_pages
									}
