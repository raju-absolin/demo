...
const StockTransferOutReport = () => {
	...
	const onFinish = ({
		...
		var objData = {
			...
			model_name: "StockTransferOutItem",
		};
		...
		const ParamsData = {
			...
			stocktransferout: stocktransferout?.value,
			item: item?.value,
			unit: unit?.value,
	...
	return (
		<GoBack
			is_goback={true}
			go_back_url={"/reports"}
			title={`Stock Transfer Out Report`}
						...
						<Grid container spacing={2}>
							...
							<Grid
								...
								<SelectComponent
									...
									placeholder="Select Stock Transfer Out"
