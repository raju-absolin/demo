...
const DeliveryReturnNotesItemReport = () => {
	const dispatch = useAppDispatch();
	const {
		mini: { miniDeliveryReturnNote, miniItemsList, miniUnits },
	...
	const onFinish = ({
		...
		var objData = {
			...
			model_name: "DeliveryReturnNotesItem",
		};
	...
	return (
		<GoBack
			is_goback={true}
			go_back_url={"/reports"}
			title={`Delivery Note Return Report`}
						...
						<Grid container spacing={2}>
							...
							<Grid
								...
								<SelectComponent
									...
									control={control}
									rules={{ required: true }}
									options={miniDeliveryReturnNote?.list.map(
										(e: {
											id: string | number;
											code: string;
										}) => ({
									...
									loading={miniDeliveryReturnNote?.loading}
									selectParams={{
										page: miniDeliveryReturnNote?.miniParams
											?.page,
										page_size:
											miniDeliveryReturnNote?.miniParams
												?.page_size,
										search: miniDeliveryReturnNote
											?.miniParams?.search,
										no_of_pages:
											miniDeliveryReturnNote?.miniParams
												?.no_of_pages,
									...
									fetchapi={getMiniDeliveryReturns}
									clearData={clearMiniDeliveryReturnNote}
								/>
							</Grid>
...
export default DeliveryReturnNotesItemReport;
