...
const MRNReport = () => {
	...
	const onFinish = ({
		...
		var objData = {
			...
			model_name: "MaterialReceivedNoteReturnItem",
		};
		...
		const ParamsData = {
			...
			mrn_return: mrn_return?.value,
			mrn_item: mrn_item?.value,
			item: item?.value,
			batch: batch?.value,
			unit: unit?.value,
		};
						...
						<Grid container spacing={2}>
							...
							<Grid
								...
								<SelectComponent
									...
									control={control}
									rules={{ required: true }}
									options={miniMRNReturn?.list.map(
										(e: {
											id: string | number;
											code: string;
										}) => ({
									...
									placeholder="Select MRN Return"
									loading={miniMRNReturn.loading}
									selectParams={{
										page: miniMRNReturn.miniParams.page,
										page_size:
											miniMRNReturn.miniParams.page_size,
										search: miniMRNReturn.miniParams.search,
										no_of_pages:
											miniMRNReturn.miniParams
												.no_of_pages,
									}}
									hasMore={
										miniMRNReturn.miniParams.page <
										miniMRNReturn.miniParams.no_of_pages
									}
									fetchapi={getMiniMRNReturn}
									clearData={clearMiniMRNReturn}
								/>
							</Grid>
							<Grid
								size={{
								...
								<SelectComponent
									...
									selectParams={{
										...
										page_size: miniMRN.miniParams.page_size,
