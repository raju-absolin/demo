    ...
    approvalData?.forEach((approval: any, index: number) => {
        ...
        timelineData[key] = [
            ...
            },
            {
                ...
                user: approval.approved_by?.fullname,
            },
        ];
    });
                                        ...
                                        <Box sx={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))" }}>
                                            <Box sx={{ gridColumn: "span 2 / span 2", gridColumnStart: { md: 2 } }}>
                                                <Box sx={{ position: "relative", ml: "80px" }}>
                                                    <Card>
                                                        <CardContent sx={{ backgroundColor: "grey.50", padding: 2 }}>
                                                            <Grid container spacing={2} alignItems="center">
                                                                <Grid size={{ xs: 2, md: 1 }}>
                                                                    <Avatar sx={{ width: 50, height: 50 }} src="" alt="" />
                                                                </Grid>
                                                                <Grid size={{ xs: 10, md: 11 }} sx={{ display: "flex", flexDirection: "column" }}>
                                                                    <Typography
                                                                        sx={{ fontSize: "16px", fontWeight: "bold", color: "grey.700", whiteSpace: "normal" }}
                                                                    >
                                                                        {item.title}
                                                                    </Typography>
                                                                    ...
                                                                    <Typography sx={{ color: "grey.600" }}>
                                                                        {item.status == "Approved" ?
                                                                            ...
                                                                            : <><strong>Rejected By:</strong> {item.user}</>
                                                                        }
                                                                    </Typography>
                                                                </Grid>
                                                            </Grid>
