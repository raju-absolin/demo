...
import { getPurchaseEnquiryById } from "@src/store/sidemenu/project_management/CompareQuotation/cq.action";
import { getPurchaseQuotations } from "@src/store/sidemenu/project_management/PurchaseQuotation/pq.action";
import { CheckedListItem } from "@src/store/sidemenu/project_management/CompareQuotation/cq.types";
...
const CompareQuotationView = () => {
	...
	useEffect(() => {
		if (id != "0" && projectId && selectedData?.purchase_enquiry?.id) {
			dispatch(
	...
	return (
		<Grid container spacing={2}>
			<Grid
				...
				<GoBack
					is_goback={true}
					go_back_url={`/work_order/view/${projectId}/${tab}/project/compare_quotation/`}
