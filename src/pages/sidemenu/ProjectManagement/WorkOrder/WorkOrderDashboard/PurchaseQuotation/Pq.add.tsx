...
import { LuDelete, LuFile, LuSave, LuTrash2, LuX } from "react-icons/lu";
import {
	clearMiniEnquiry,
	clearMiniMake,
	clearMiniCurrencies,
...
import { QuotationItem } from "@src/store/sidemenu/project_management/PurchaseQuotation/pq.types";
import { PQItem } from "@src/store/sidemenu/project_management/purchaseEnquiry/purchase_enquiry.types";
...
const createPQItem = (item: QuotationItem) => {
	return {
		peItem: item,
		qty: item.qty,
		item: item?.item,
