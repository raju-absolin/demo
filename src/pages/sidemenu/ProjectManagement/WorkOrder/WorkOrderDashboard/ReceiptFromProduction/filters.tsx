...
import { selectReceiptFromProduction } from "@src/store/sidemenu/project_management/ReceiptFromProduction/RFP.slice";
...
const Filters = ({ openFilter, handleFilter }: Props) => {
	...
	const { id } = useParams();
	const {
		receiptFromProduction: { pageParams },
		mini: { miniWarehouse },
				...
				<Box
					...
					<Box sx={{ display: "flex", flexDirection: "column" }}>
						<Typography variant="h5" sx={{ mb: 1 }}>
							Receipt From Production Filters
						</Typography>
						<Divider
							sx={{
								mb: 1,
