...
import { selectDeliveryReturnNotes } from "@src/store/sidemenu/project_management/DeliveryNoteReturn/DNR.slice";
...
const Filters = ({ openFilter, handleFilter }: Props) => {
	...
	const { id } = useParams();
	const {
		deliveryReturnNotes: { pageParams },
		mini: {
			miniWarehouse,
			miniLocationLoading,
			miniLocationList,
