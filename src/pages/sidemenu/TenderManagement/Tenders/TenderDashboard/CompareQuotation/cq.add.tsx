...
import {
	PQItem,
	Vendor,
} from "@src/store/sidemenu/tender_mangement/purchaseEnquiry/purchase_enquiry.types";
import {
	CheckedListItem,
	RequestPayload,
} from "@src/store/sidemenu/tender_mangement/CompareQuotation/cq.types";
...
const CompareQuotations = () => {
	...
	const getQuotationForItemMakeAndVendor = useCallback(
		(
			...
			return (quotations as Quotation[])?.find(
				(q: Quotation) =>
	...
	}, [tenderSelectedData, selectedData]);
