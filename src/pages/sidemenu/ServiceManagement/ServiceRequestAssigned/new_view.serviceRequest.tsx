...
import { getServiceRequestById } from "@src/store/sidemenu/service_management/ServiceRequestAssigned/serviceRequestAssigned.action";
import {
				...
				<Box>
					<Stack
						...
						{selectedData?.status != 1 &&
							selectedData?.status != 6 &&
							selectedData?.status != 7 && (
								<>
									<AssignUserModal />
									<GroupedAvatars />
								</>
