...
import { ServiceRequestApprovalsState } from "@src/store/sidemenu/service_management/ServiceRequestApprovals/serviceRequestApprovals.types";
...
interface Props {
	pageParams?: ServiceRequestApprovalsState["pageParams"];
}
