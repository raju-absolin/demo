...
const AuthLayout2 = ({
	...
	const { themeMode } = useAppSelector((state) => selectLayoutTheme(state));
						...
						<Swiper
							...
							<SwiperSlide>
								...
								<Typography
									...
									Love the overall look and feel. Not too
									flashy, and still very professional and
									smart.
									<LuQuote size={16} />
								</Typography>
								<Typography
							...
							<SwiperSlide>
								...
								<Typography
									...
									<LuQuote
										...
										style={{ transform: "scaleX(-1)" }}
									/>
									Pretty nice theme, hoping you guys could add
									more features to this. Keep up the good
									work.
									<LuQuote size={16} />
								</Typography>
								<Typography
							...
							<SwiperSlide>
								...
								<Typography
									...
									<LuQuote
										...
										style={{ transform: "scaleX(-1)" }}
									/>
									This is a great product, helped us a lot and
									very quick to work with and implement.
									<LuQuote size={16} />
								</Typography>
								<Typography
									variant="caption"
